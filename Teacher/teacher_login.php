						...
						<div class="card-content" style="padding-top: 4% !important; padding-bottom: 8% !important;">
							...
							<form>
								...
								<div class="form-group">
									...
									<div class="input-group login-page-gp">
										<span class="login-page-gp-pp"><i class="bi bi-key-fill"></i></span>
										<input id="inputPassword" class="form-control" type="password" tabindex="2"
											placeholder="Enter Password" required>
									</div>
								</div>

								<div class="d-flex login-page-jcb login-page-mb-1 login-page-mt-1">
									<div class="login-page-control login-page-checkbox">
										<input id="temsAndConditions" class="login-page-control-input" type="checkbox">
										<label class="login-page-control-label" for="temsAndConditions">Remember
											me</label>
									</div>

									<a class="login-page-ft-b" style="text-decoration: none; color: white;" href="forget.html">Forgot password?</a>
								</div>

								<button type="submit" class="btn btn-block btn-primary login-page-btn">Log In</button>
							</form>
						</div>
					</div>
				</div>
